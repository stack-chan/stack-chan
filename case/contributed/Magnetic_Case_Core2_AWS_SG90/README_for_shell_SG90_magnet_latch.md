...
- Bracket
  - Added pocket for servo PCB
  - Improved lead wire routing (can be wrapped around the bracket)
  ![shell_SG90_magnet_latch](./docs/images/blacket_pcba.jpg)
  ![shell_SG90_magnet_latch](./docs/images/blacket.jpg)
  
- Other
  - Optimized model geometry for Bambu P1S printing (gap-expanding direction)

# Appearance
![shell_SG90_magnet_latch](./docs/images/shell_SG90_magnet_latch2.jpg)
