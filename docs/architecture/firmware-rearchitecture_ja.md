...
- [x] 対応済み：`firmware/chat.md`（現 `firmware/docs/chat-audioio-integration.md`）の `Robot/Mod`、`FaceContext`、旧 `tests/chats/` 前提を `StackchanContext`、capability API、移行後の test 配置へ更新する。
