...
test('App exposes capability contracts instead of the concrete Robot facade at the MOD boundary', () => {
  ...
  assert.match(capabilities, /@deprecated Use the namespaced capabilities on `StackchanContext` instead/)
  assert.match(capabilities, /@deprecated Use `context\.audio\.say\(\.\.\.\)` instead/)
  ...
  assert.doesNotMatch(runtimeContext, /void this\.#updateFaceHandler/)
