...
export default class RuntimeBitmapPort extends Port {
  clearBitmap() {
    this._runtimeBitmap = undefined
    this._runtimeBitmapSX = undefined
    this._runtimeBitmapSY = undefined
    this._runtimeBitmapSW = undefined
    this._runtimeBitmapSH = undefined
  }
