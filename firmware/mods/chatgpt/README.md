...
```console
# For M5Stack Basic/Gray/Fire. Use flash:core2 for Core2.
$ npm run flash:basic -- ssid=[Network SSID to use] password=[Network password to use]
```
...
```console
# For M5Stack Basic/Gray/Fire. Use `core2` instead of `basic` for Core2.
