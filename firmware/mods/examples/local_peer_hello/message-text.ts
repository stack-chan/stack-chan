...
export function sanitizeReceivedText(value: unknown) {
...
export function extractReceivedText(payload: unknown) {
  if (payload === null || typeof payload !== 'object' || Array.isArray(payload)) return undefined
  return sanitizeReceivedText((payload as Record<string, unknown>).text)
}
