...
export type FaceDecorator = (tick: number, face: Readonly<FaceContext>, end?: boolean) => void
...
export class Renderer {
  ...
  constructor() {
    ...
    this.#face = createFaceContainer('simple', undefined, undefined, this.handleDecorators.bind(this))
