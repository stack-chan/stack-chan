...
const m5StackChanCoreS3Manifest = JSON.parse(readFileSync('platforms/m5stackchan_cores3/manifest.json', 'utf8'))
...
describe('Stack-chan platform manifest', () => {
  test('gives M5StackChan CoreS3 the same expandable XS creation heap as CoreS3', () => {
    ...
    const m5StackChanCoreS3Creation = m5StackChanCoreS3Manifest.creation
